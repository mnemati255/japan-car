...
export const navData: NavSectionProps['data'] = [
    ...
    items: [
      {
        ...
        icon: ICONS.folder,
        children: [
          { title: 'List', path: paths.dashboard.auction.root },
          { title: 'Create', path: paths.dashboard.auction.new },
        ],
      },
      {
        title: 'Users',
  ...
  //        * Example usage can be found in: @/sections/_examples/extra/navigation-bar-view/nav-vertical.{jsx | tsx}
  //        */
  //       title: 'Permission',
